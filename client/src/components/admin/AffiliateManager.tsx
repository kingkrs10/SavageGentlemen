...
export function AffiliateManager() {
    ...
    const totalClicks = affiliates?.reduce((acc: number, curr: any) => acc + (curr.clickCount || 0), 0) || 0;
                        ...
                        <Table>
                            <TableHeader>
                                <TableRow className="border-b border-zinc-800 hover:bg-transparent">
                                    ...
                                    <TableHead className="text-zinc-400 font-semibold text-center">Commission</TableHead>
                                    ...
                                    affiliates?.map((affiliate: any) => (
                                        <TableRow key={affiliate.id} className="border-b border-zinc-800/50 hover:bg-zinc-800/20">
                                            <TableCell className="font-medium text-white">
                                                {affiliate.user?.displayName || affiliate.user?.username || 'Unknown'}
