          ...
          <div className="relative h-full">
            <div className="h-full w-full bg-background">
              ...
              <div className="absolute inset-0 bg-gradient-to-b from-black/50 via-black/30 to-black/70 z-10 flex flex-col items-center justify-center">
                ...
                <h1 className="text-5xl md:text-7xl font-heading text-foreground uppercase tracking-wide mb-6 [text-shadow:_0_2px_5px_rgba(0,0,0,0.7)] text-center">
                  SAVAGE GENTLEMEN
                </h1>

                <p className="text-xl md:text-2xl text-foreground/90 max-w-2xl mx-auto mb-12 uppercase tracking-widest [text-shadow:_0_1px_3px_rgba(0,0,0,0.9)] text-center">
        ...
        <div className="container mx-auto px-4 max-w-6xl">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="space-y-6">
              ...
              <h2 className="text-4xl md:text-5xl font-bold uppercase tracking-wider text-foreground leading-tight">
            ...
            {featuredEvents && featuredEvents.length > 0 && (
              <section>
                <div className="flex items-center justify-between mb-8">
                  ...
                  <Link href="/events">
                    <Button variant="outline" className="btn-modern glass-effect border-foreground/20 text-foreground hover:bg-foreground/10 group">
                      View All
            ...
            {featuredProducts && featuredProducts.length > 0 && (
              <section className="py-20 bg-gradient-to-b from-background to-card">
                <div className="text-center mb-12">
                  ...
                  <h2 className="text-4xl md:text-5xl font-bold uppercase tracking-wider text-foreground mb-4">
                    EXPLORE MERCH
                  </h2>
                  ...
                  <div className="aspect-video relative bg-muted">
                    {livestreamLoading ? (
                      ...
                      <div className="w-full h-full flex items-center justify-center bg-muted">
                        <Play className="h-16 w-16 text-foreground/50" />
                      </div>
                    )}
