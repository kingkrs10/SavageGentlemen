...
const creatorBots: CreatorBot[] = [
  ...
  {
    id: "guyana-carnival-2027",
    name: "Guyana Carnival 2027 Ops",
    category: "Multi-Band Organizer Command Center",
    icon: "🇬🇾",
    priceTag: "Organizer Portal",
    priceAmount: 0,
    description: "Unified operations, distribution tracking, and run-of-show hub for SavageGentlemen x Euphoria Mas x Island Vibes x Carnival-Planner.",
    status: "ACTIVE",
    features: ["Milestone Roadmap & GPF/GRA Permits", "Carnival-Planner Distribution Desk", "Carnival Week Master Run-of-Show"],
  ...
  {
    id: "ad-studio-ai",
    name: "Savage Ad Studio AI",
    category: "Omnichannel Video Ad Automation",
    icon: "🚀",
    priceTag: "Instant Render",
    priceAmount: 0,
    description: "Converts Shop merchandise and Events into 9:16 vertical video ads (1080x1920) and auto-publishes to Instagram, Facebook, YouTube Shorts & TikTok.",
    status: "AUTONOMOUS",
    features: ["1080x1920 9:16 FFmpeg Video Engine", "Multi-Platform Auto-Post (IG/FB/YT/TikTok)", "Printify Merch & Events Direct Ingestion"],
    path: "/apps/ad-studio",
    accent: "gold",
  },
  {
  ...
  {
    id: "cymatics-visualizer",
    name: "Cymatics 3D Resonance",
    category: "Chladni Audio Visualizer",
    icon: "🔥",
    priceTag: "Live 3D WebGL",
    priceAmount: 0,
    description: "3D Cymatics & Chladni plate resonance simulation. Sub-bass kick transients trigger radial shockwave pulses, while 400Hz–2kHz mid harmonics sculpt geometric nodal lines.",
    status: "ACTIVE",
    features: ["Radial Bessel & Chladni Nodal Physics", "Fast 20–100Hz Transient Kick Bounce", "Audio Uploader & Default Track Loader"],
    path: "/cymatics",
    accent: "gold",
  },
  {
