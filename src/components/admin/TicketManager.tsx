...
const TicketManager: React.FC = () => {
  ...
  const {
    ...
    queryKey: ['/api/events', selectedEvent?.id, 'tickets'],
    queryFn: async () => {
  ...
  const updateTicketMutation = useMutation({
    mutationFn: async ({ ticketId, ticketData }: { ticketId: number, ticketData: any }) => {
      console.log("Updating ticket", ticketId, "with data:", ticketData);
      return apiRequest('PUT', `/api/events/${ticketData.eventId}/tickets/${ticketId}`, ticketData);
    },
    onSuccess: () => {
      toast({
        title: 'Success',
  ...
  const deleteTicketMutation = useMutation({
    mutationFn: async (ticketId: number) => {
      ...
      return apiRequest('DELETE', `/api/events/${selectedEvent?.id}/tickets/${ticketId}`);
    },
    onSuccess: () => {
      toast({
        title: 'Success',
                  ...
                  <div className="grid grid-cols-2 gap-4">
                    <div className="flex items-center space-x-2">
                      <Checkbox
                        ...
                        onCheckedChange={(checked) => setTicketFormData({ ...ticketFormData, earlyAccess: checked === true })}
                      />
                    ...
                    <div className="flex items-center space-x-2">
                      <Checkbox
                        ...
                        onCheckedChange={(checked) => setTicketFormData({ ...ticketFormData, prioritySupport: checked === true })}
                      />
                    ...
                    <div className="flex items-center space-x-2">
                      <Checkbox
                        ...
                        onCheckedChange={(checked) => setTicketFormData({ ...ticketFormData, exclusiveContent: checked === true })}
                      />
                    ...
                    <div className="flex items-center space-x-2">
                      <Checkbox
                        ...
                        onCheckedChange={(checked) => setTicketFormData({ ...ticketFormData, meetGreet: checked === true })}
                      />
                    ...
                    <div className="flex items-center space-x-2">
                      <Checkbox
                        ...
                        onCheckedChange={(checked) => setTicketFormData({ ...ticketFormData, backstageAccess: checked === true })}
                      />
                    ...
                    <div className="flex items-center space-x-2">
                      <Checkbox
                        ...
                        onCheckedChange={(checked) => setTicketFormData({ ...ticketFormData, transferable: checked === true })}
                      />
                    ...
                    <div className="flex items-center space-x-2">
                      <Checkbox
                        ...
                        onCheckedChange={(checked) => setTicketFormData({ ...ticketFormData, refundable: checked === true })}
                      />
