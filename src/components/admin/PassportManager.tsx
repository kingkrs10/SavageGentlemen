...
interface PassportProfilesResponse {
...
export default function PassportManager() {
  ...
  const { data: profilesData, isLoading: profilesLoading } = useQuery<PassportProfilesResponse>({
  ...
  // Fetch promoters
  const { data: promotersData, isLoading: promotersLoading } = useQuery<PromotersResponse>({
