...
const AdSpace = () => {
  ...
  const ads: AdData[] = sponsoredContent.map((ad: any) => ({
    ...
    linkUrl: ad.linkUrl,
    backgroundColor: ad.backgroundColor || 'bg-card',
  ...
  const placeholderAds: AdData[] = [
    // Carnival Planner Ad
    {
      id: "carnival-planner",
      type: "banner",
      title: "Simply Your Carnival",
      description: "Plan your ultimate carnival experience with ease. Events, costumes, flights and more.",
      imageUrl: "/uploads/carnival-planner-ad.png",
      backgroundColor: "bg-black",
      textColor: "text-white",
      ctaText: "Start Planning",
      linkUrl: "https://carnival-planner.com"
    },
    // Standard ad
    {
      id: "sponsor-1",
      ...
      backgroundColor: "bg-gradient-to-r from-blue-900/40 to-purple-900/40 border border-white/5",
      textColor: "text-white",
      ctaText: "Learn More",
      linkUrl: "#"
    },
    ...
    // Product showcase ad
    {
      ...
      backgroundColor: "bg-gradient-to-r from-purple-900/60 to-pink-900/60 border border-white/10",
      textColor: "text-white",
      ctaText: "Shop Now",
      linkUrl: "#",
      price: "$29.99"
    ...
    // Event promotion ad
    {
      ...
      backgroundColor: "bg-gradient-to-r from-primary/80 to-red-800/80",
      textColor: "text-white",
      ctaText: "Buy Tickets",
      linkUrl: "/events",
      ...
      case 'event':
        return (
          <div className="relative overflow-hidden rounded-lg">
            ...
            <div className={`${!ad.imageUrl ? ad.backgroundColor : 'bg-card'} p-4`}>
              <h3 className={`font-bold text-lg mb-2 ${ad.textColor}`}>
                {ad.title}
              </h3>
  ...
  return (
    <div className="space-y-4">
      ...
      <Card className="border border-dashed border-white/10 bg-card/30">
