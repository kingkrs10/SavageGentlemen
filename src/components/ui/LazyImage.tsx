...
export function LazyImage({
  ...
  if (finalSrc && typeof finalSrc === 'string' && finalSrc.includes('uploads/') && !finalSrc.startsWith('/')) {
    finalSrc = `/${finalSrc}`;
  }
  ...
  return (
    <div className="relative w-full h-full">
      ...
      {/* The actual image - only render if we have a valid source */}
      {finalSrc && (
        <img
          ref={imgRef}
          src={error && fallbackSrc ? fallbackSrc : (inView ? finalSrc : undefined)}
          alt={alt}
