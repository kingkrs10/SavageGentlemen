...
async function sendComplimentaryTickets() {
  try {
    ...
    // Use the existing Brevo configuration from the system
    const transporter = nodemailer.createTransport({
      ...
      auth: {
        ...
        pass: 'xsmtpsib-fced1fca7d8cd3e0b62c3eb95f7de8b9fd2c9c2cae6dc7e42e84bac7e1c86f5e-Pz4Zj8fqpnXYKr6g'
      }
    });

    console.log('Generating QR codes...');
    
    // Generate QR code buffers for the two tickets
    const qrCode1Buffer = await qrcode.toBuffer('EVENT-7-ORDER-149-1753404658-1', {
      width: 300,
      margin: 2,
      color: {
        dark: '#000000',
    ...
    const qrCode2Buffer = await qrcode.toBuffer('EVENT-7-ORDER-149-1753404658-2', {
      width: 300,
      margin: 2,
      color: {
        dark: '#000000',
