...
async function sendComplimentaryTickets() {
  try {
    console.log('Starting to send complimentary tickets to Jclay via MailerSend...');
...
<body>
    <div class="container">
        ...
        <div class="ticket-section">
            ...
            <div style="margin: 20px 0;">
                ...
                <div class="ticket-qr">
                    <img src="${qrCode1}" alt="QR Code 1" style="max-width: 250px;" />
                </div>
            ...
            <div style="margin: 20px 0;">
                ...
                <div class="ticket-qr">
                    <img src="${qrCode2}" alt="QR Code 2" style="max-width: 250px;" />
                </div>
    ...
    if (response.ok) {
      ...
      throw new Error(`MailerSend API failed: ${response.status} ${response.statusText} - ${responseText}`);
    }
